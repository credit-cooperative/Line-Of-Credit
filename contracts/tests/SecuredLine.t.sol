...
contract SecuredLineTest is Test {
    ...
    function test_can_liquidate_if_debt_when_deadline_passes() public {
        ...
        vm.stopPrank();
        vm.startPrank(lender);
        uint256 tokenId = line.addCredit(dRate, fRate, 1 ether, address(supportedToken1), lender, 0);
...
// declareInsolvent
    ...
    function test_amend_and_extend_clears_credit_proposals() public {
        ...
        vm.startPrank(lender);
        line.addCredit(dRate, fRate, 100 ether, address(supportedToken1), lender, 0);
        vm.stopPrank();
