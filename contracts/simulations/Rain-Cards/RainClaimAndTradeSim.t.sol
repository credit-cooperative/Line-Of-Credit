...
contract RainRe7Sim is Test {
    ...
    function test_claim_and_trade_and_repay() public {
        ...
        uint256 balanceOfLineBefore = IERC20(creditToken).balanceOf(address(spigotedLine));
        ...
        uint256 balanceOfLineAfter = IERC20(creditToken).balanceOf(address(spigotedLine));
