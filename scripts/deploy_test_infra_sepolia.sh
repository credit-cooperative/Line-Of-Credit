...
SimpleRevenueContract=$(forge create --rpc-url $GOERLI_RPC_URL --constructor-args 0x06dae7Ba3958EF288adB0B9b3732eC204E48BC47 0xF64fC04626d3f0CA01d7C23cA77110D2B5fd8893 \
 --private-key $GOERLI_PRIVATE_KEY --etherscan-api-key $MAINNET_ETHERSCAN_API_KEY contracts/mock/SimpleRevenueContract.sol:SimpleRevenueContract --verify --json)
