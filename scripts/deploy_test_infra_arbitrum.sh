...
SimpleRevenueContract=$(forge create --rpc-url $ARBITRUM_RPC_URL --constructor-args 0x06dae7Ba3958EF288adB0B9b3732eC204E48BC47 0xaf88d065e77c8cC2239327C5EDb3A432268e5831 \
 --private-key $ARBITRUM_PRIVATE_KEY --etherscan-api-key $ARBISCAN_API_KEY contracts/mock/SimpleRevenueContract.sol:SimpleRevenueContract --verify --json)
...
#     --rpc-url $ARBITRUM_RPC_URL --etherscan-api-key $ARBISCAN_API_KEY \
