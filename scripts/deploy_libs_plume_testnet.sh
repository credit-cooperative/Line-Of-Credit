...
LineLib=$(forge create --rpc-url $PLUME_TESTNET_RPC_URL --private-key $PLUME_TESTNET_PRIVATE_KEY --etherscan-api-key $PLUME_TESTNET_EXLPORER_API_KEY  --optimizer-runs 20000 contracts/utils/LineLib.sol:LineLib --json --verify)
...
CreditLib=$(forge create --rpc-url $PLUME_TESTNET_RPC_URL --private-key $PLUME_TESTNET_PRIVATE_KEY --etherscan-api-key $PLUME_TESTNET_EXLPORER_API_KEY --optimizer-runs 200 contracts/utils/CreditLib.sol:CreditLib --verify --json)
...
CreditListLib=$(forge create --rpc-url $PLUME_TESTNET_RPC_URL --private-key $PLUME_TESTNET_PRIVATE_KEY --etherscan-api-key $PLUME_TESTNET_EXLPORER_API_KEY --optimizer-runs 200 contracts/utils/CreditListLib.sol:CreditListLib --verify --json)
...
SpigotLib=$(forge create --rpc-url $PLUME_TESTNET_RPC_URL --private-key $PLUME_TESTNET_PRIVATE_KEY --etherscan-api-key $PLUME_TESTNET_EXLPORER_API_KEY --optimizer-runs 200 contracts/utils/SpigotLib.sol:SpigotLib --verify --json)
...
EscrowLib=$(forge create --rpc-url $PLUME_TESTNET_RPC_URL --private-key $PLUME_TESTNET_PRIVATE_KEY --etherscan-api-key $PLUME_TESTNET_EXLPORER_API_KEY --optimizer-runs 200 contracts/utils/EscrowLib.sol:EscrowLib --verify --json)
...
SpigotedLineLib=$(forge create --rpc-url $PLUME_TESTNET_RPC_URL --private-key $PLUME_TESTNET_PRIVATE_KEY --etherscan-api-key $PLUME_TESTNET_EXLPORER_API_KEY --optimizer-runs 200 contracts/utils/SpigotedLineLib.sol:SpigotedLineLib --verify --json)
...
LineFactoryLib=$(forge create --rpc-url $PLUME_TESTNET_RPC_URL --private-key $PLUME_TESTNET_PRIVATE_KEY --etherscan-api-key $PLUME_TESTNET_EXLPORER_API_KEY --optimizer-runs 200 contracts/utils/LineFactoryLib.sol:LineFactoryLib --verify --json)
