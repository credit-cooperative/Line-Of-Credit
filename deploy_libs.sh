...
LineLib=$(forge create --rpc-url $MAINNET_RPC_URL --private-key $MAINNET_PRIVATE_KEY --etherscan-api-key $MAINNET_ETHERSCAN_API_KEY  contracts/utils/LineLib.sol:LineLib --json --verify)
...
CreditLib=$(forge create --rpc-url $MAINNET_RPC_URL --private-key $MAINNET_PRIVATE_KEY --etherscan-api-key $MAINNET_ETHERSCAN_API_KEY contracts/utils/CreditLib.sol:CreditLib --verify --json)
...
CreditListLib=$(forge create --rpc-url $MAINNET_RPC_URL --private-key $MAINNET_PRIVATE_KEY --etherscan-api-key $MAINNET_ETHERSCAN_API_KEY contracts/utils/CreditListLib.sol:CreditListLib --verify --json)
...
SpigotLib=$(forge create --rpc-url $MAINNET_RPC_URL --private-key $MAINNET_PRIVATE_KEY --etherscan-api-key $MAINNET_ETHERSCAN_API_KEY contracts/utils/SpigotLib.sol:SpigotLib --verify --json)
...
EscrowLib=$(forge create --rpc-url $MAINNET_RPC_URL --private-key $MAINNET_PRIVATE_KEY --etherscan-api-key $MAINNET_ETHERSCAN_API_KEY contracts/utils/EscrowLib.sol:EscrowLib --verify --json)
...
SpigotedLineLib=$(forge create --rpc-url $MAINNET_RPC_URL --private-key $MAINNET_PRIVATE_KEY --etherscan-api-key $MAINNET_ETHERSCAN_API_KEY contracts/utils/SpigotedLineLib.sol:SpigotedLineLib --verify --json)
...
LineFactoryLib=$(forge create --rpc-url $MAINNET_RPC_URL --private-key $MAINNET_PRIVATE_KEY --etherscan-api-key $MAINNET_ETHERSCAN_API_KEY contracts/utils/LineFactoryLib.sol:LineFactoryLib --verify --json)
